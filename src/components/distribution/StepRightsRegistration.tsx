...
import { useSplitSongs, useSplitEntries } from "@/hooks/useSplits";
...
export function StepRightsRegistration({ form, updateForm, teamId }: Props) {
  ...
  // Get all entries for all songs in this split project
  ...
  // Unique contributors from entries
  ...
  return (
    <div className="space-y-6">
      ...
      {!form.split_project_id && (
        <Card className="p-6 text-center border-dashed">
          <Shield className="h-8 w-8 mx-auto text-muted-foreground mb-3" />
          <p className="text-sm text-muted-foreground">
            Link a split project in Step 1 to validate contributor rights data
          </p>
        </Card>
      )}
        ...
        <>
          ...
          <Card className="p-4 space-y-4">
            ...
            <p className="text-xs text-muted-foreground">
              ...
              mechanical royalties from streaming. Each song on the release should be filed.
            </p>
          ...
          <Card className="p-4 space-y-3">
            ...
            <p className="text-xs text-muted-foreground">
              ...
              for additional legal protection. While copyright exists at creation, registration 
